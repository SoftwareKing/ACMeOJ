...
public class BaseInfo {
	...
	private String welcomeInfo;//首页滚动条信息
	...
	public String toString() {
		return "BaseInfo [address=" + address + ", domainName=" + domainName
				+ ", email=" + email + ", indexPicHeight=" + indexPicHeight
				+ ", indexPicNumber=" + indexPicNumber + ", indexPicWidth="
				+ indexPicWidth + ", name=" + name + ", phone=" + phone
				+ ", recordCode=" + recordCode + ", welcomeInfo=" + welcomeInfo
				+ ", zipCode=" + zipCode + "]";
	}
