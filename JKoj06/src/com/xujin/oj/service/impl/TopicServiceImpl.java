...
import com.xujin.oj.dao.AttachmentDao;
import com.xujin.oj.dao.ChannelDao;
import com.xujin.oj.dao.TopicDao;
...
public class TopicServiceImpl implements TopicService {
	...
	@Override
	public Pager<Topic> pagerTopicByChannel(int cid) {
		return topicDao.pagerTopicsByChannel(cid);
	}
