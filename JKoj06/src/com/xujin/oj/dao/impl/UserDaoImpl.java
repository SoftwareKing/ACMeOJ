...
import com.xujin.oj.model.UserGroup;
import com.xujin.oj.model.UserRole;
...
public class UserDaoImpl extends BaseDaoImpl<User> implements UserDao {
	...
	@Override
	public Pager<User> getStandings(String order) {
	...
	@Override
	public List<User> getIndexTop(String order) {
        String hql =new String();
		if("rate".equals(order)){
			hql = "select u from User u order by u.rating DESC, u.solved DESC, u.submit ASC,u.id ASC";
		}else if("solved".equals(order)){
			hql = "select u from User u order by u.solved DESC,u.rating DESC, u.submit ASC,u.id ASC";
		}else {
			hql = "select u from User u order by u.solved DESC,u.rating DESC, u.submit ASC,u.id ASC";
		}
