...
import com.xujin.oj.dto.AjaxObj;
import com.xujin.oj.dto.TopicDto;
...
import com.xujin.oj.utils.JsonUtil;
...
public class TopicController {
	...
	public String changeStatus(@PathVariable int id,Integer status) {
		if(id==9){
			throw new CmsException("该文章不能改变状态！");
	...
	public String delete(@PathVariable int id,Integer status) {
		Topic t = topicService.load(id);
		if(id==9){
			throw new CmsException("该文章不能删除！");
		}
		else{
