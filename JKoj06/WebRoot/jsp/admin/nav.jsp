...
<c:if test="${isAdmin }">
	<ul class="navMenu navSelected">
		<h3 class="navTitle">
			<span class="navTilteTxt">ACMeOJ管理</span>
		</h3>
		<li class="navChild">
			<a href="<%=request.getContextPath() %>/admin/problem/problems" target="content">题目管理</a>
		</li>
		<li class="navChild">
			<a href="<%=request.getContextPath() %>/admin/contest/contests" target="content">比赛管理</a>
		</li>
