...
<html>
  <head>
  	<title>ACME OJ CONTEST STATUS</title>
  ...
  <body>
    ...
    <div id="ACMeOJ-total">
    	...
    	<div id="ACMeOJ-main">
				...
				<h1>Contest Problem Status List</h1>
				...
				<div style="float: left;">
					<form action="<%=request.getContextPath() %>/contest/problem/status/${contest.contestId}" method="POST" name="Sstatus">
