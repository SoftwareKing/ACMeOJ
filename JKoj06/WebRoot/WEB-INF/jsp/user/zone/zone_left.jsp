    ...
    <div id="div_left">
		...
		<div id="ua_nav">
			...
			<div style="color: #000000; display: inline;">
				<p>Hello, <font color="#FFFFFF">${loginUser.nickname }</font></p>
				<table style="float:left; margin-left:3px;">
					<tr>
						<td>ID:</td>
						<td><font color="#FFFFFF">${loginUser.username }</font></td>
					</tr>
					<tr>
						<td>School:</td>
						<td><font color="#FFFFFF">${loginUser.school }</font></td>
					</tr>
					<tr>
						<td>Email:</td>
						<td><font color="#FFFFFF">${loginUser.email }</font></td>
					</tr>
					<tr>
						<td>Phone:</td>
						<td><font color="#FFFFFF">${loginUser.phone }</font></td>
					</tr>
				</table>
			</div>
			<div class="clear"></div>
		...
		<div id="ua_nav">
			<div id="ua_menu">
				<a href="<%=request.getContextPath() %>/user/userlogs">Log</a>
			</div>
			<div class="clear"></div>
			<div id="ua_menu">
				<a href="<%=request.getContextPath() %>/user/aceproblem">Ace</a>
			</div>
			<div class="clear"></div>
			<div id="ua_menu">
				<a href="<%=request.getContextPath() %>/user/updateSelf">Modifying Data</a>
			</div>
			<div class="clear"></div>
			<div id="ua_menu">
				<a href="<%=request.getContextPath() %>/user/updatePwd">Modifying password</a>
			</div>
			<div class="clear"></div>
		</div>
		<div id="ua_nav_connect"></div>
