...
<BODY>
		<div id=header>
				...
				<fieldset id="signin_menu">
					<form action="<%=request.getContextPath() %>/user/login/" method="POST" name="form"
						...
						<fieldset>
							...
							<input name="checkcode" id="id_checkcode" style="width: 115px;"
								type="text">
							<img src="<%=request.getContextPath() %>/drawCheckCode" id="yzmimg"
								class="ACMeOJ-yzmimg">
						</fieldset>
						<input class="ACMeOJ-sunbmit" value="Login"
							onClick="return check_login();" style="margin-right: 20px;"
							type="submit">
			...
			<!--end ACMeOJ-user_side-->
					<DIV id=logo>
						<DIV id=site>
						  <img src="<%=request.getContextPath() %>/resources/site_media/css/base/img/ojlogo.jpg" alt="迪赛网络-龙岩网站建设">
							<FORM id=search method=post action=search>
								<INPUT style="height:20px;"onblur="if(this.value=='') this.value='请输入您要搜索的关键字';" id=inputxt onfocus="if(this.value=='请输入您要搜索的关键字') this.value='';" value=请输入您要搜索的关键字>
								<INPUT id=inputsubmit onClick="location.href='#" value=Search type=button> 
								<DIV class=clear></DIV>
							</FORM>
						</DIV>    <!-- end site -->
			 ...
			 <!-- Menu  -->
		<jsp:include page="/WEB-INF/jsp/base/contestmenu.jsp"></jsp:include>
